...
function update(){
  ...
  function draw(){
    ...
    ctx.fillText("Touch the surface of the liquid",70,canvas.height/2-20);
    ctx.fillStyle="#fff";
    ctx.fillText("Copyright © 1999-2020 Verniy All Rights Reserved",70,canvas.height/2+15);
    ctx.fillText("Use mouse wheel to change the viscosity / Viscosity: "+((dd-15)*20/7).toFixed(2)+"%",70,canvas.height-20);
}
